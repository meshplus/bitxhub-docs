...
`pier appchain`具体描述与使用示例参考[中继模式管理](/v1.6/bitxhub/function/relay_manager/)。
...
`pier appchain`具体描述与使用示例参考[直连模式管理](/v1.6/bitxhub/function/direct_manager/)。
...
`pier rule`具体描述与使用示例参考[直连模式管理](/v1.6/bitxhub/function/direct_manager/)的部署验证规则模块。
